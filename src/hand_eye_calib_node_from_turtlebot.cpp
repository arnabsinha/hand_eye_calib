...
public:
      ...
      nh_("~"), it_(nh_), calibrated(false)
  {
    ...
    nh_.param<std::string>("fixed_frame", fixed_frame, "/robot_base");
    nh_.param<std::string>("camera_frame", camera_frame, "/kinect2_rgb_optical_frame");
    nh_.param<std::string>("target_frame", target_frame, "/calibration_pattern");
    nh_.param<std::string>("tip_frame", tip_frame, "/end_effector");
    ...
    info_sub_ = nh_.subscribe("/kinect2/rgb_rect/camera_info", 1, &CalibrateKinectCheckerboard::infoCallback, this);
    ...
    nh_.param<double>("gripper_tip_x", gripper_tip.point.x, 0.0832);
    nh_.param<double>("gripper_tip_y", gripper_tip.point.y, 0.0112);
  ...
  void infoCallback(const sensor_msgs::CameraInfoConstPtr& info_msg)
  {
    ...
    calibrated = true;
    image_sub_ = nh_.subscribe("/kinec2/rgb_rect/image", 1, &CalibrateKinectCheckerboard::imageCallback, this);
...
//      input_bridge_ = cv_bridge::toCvCopy(image_msg, "mono8");
      input_bridge_ = cv_bridge::toCvCopy(image_msg, sensor_msgs::image_encodings::TYPE_16UC1);
